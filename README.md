This program is a student database manager. This allows the function of adding and tracking the student's name, classes, grades as well as creating a report card for each class and student. 
